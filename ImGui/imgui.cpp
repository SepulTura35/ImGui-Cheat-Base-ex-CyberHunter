...
ImGuiStyle::ImGuiStyle()
{
	...
	WindowRounding = 2.0f;             // Radius of window corners rounding. Set to 0.0f to have rectangular windows
	...
	WindowTitleAlign = ImVec2(0.50f, 0.5f);// Alignment for title bar text
